      ...
      {canManage && (
        <form onSubmit={handleSubmit} className="mb-5">
          ...
          <p className="mt-2 text-xs text-muted">
            Плановая ставка для управленческого учёта — не формирует расход автоматически и не
            отражается в денежном потоке. Учитывается в плановом ФЗП при расчёте точки
            безубыточности. Фактическую выплату необходимо провести через Финансы → Расходы →
            статья «Зарплата».
          </p>
        </form>
      )}
